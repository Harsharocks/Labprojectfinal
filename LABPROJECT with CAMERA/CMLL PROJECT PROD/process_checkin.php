...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($rNumber !== "" && $purpose !== "" && $capturedImage !== "") {
        ...
        $imageFileName = "C:/xampp/htdocs/cmll-project/LABPROJECT with CAMERA/camera/{$rNumber}_{$dateTime}.jpg";
        ...
        if (file_put_contents($imageFileName, $imageData)) {
            ...
            if ($stmt->num_rows > 0) {
                ...
                $insertSql = "INSERT INTO checkins (r_number, purpose, first_name, last_name, checkin_date, checkin_time, checkin_preview) VALUES (?, ?, ?, ?, CURDATE(), CURTIME(), ?)";
