...
// SQL query to fetch active users for the current date
$sql = "SELECT r_number, first_name, last_name, purpose, checkin_time, checkout_time FROM checkins WHERE checkin_date = '$currentDate'";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "</div>";
        echo "<div class='user-info'>";
        echo "Checkin Time: " . $row["checkin_time"];
        echo "</div>";
        echo "<div class='user-info'>";
        echo "Checkout Time: " . $row["checkout_time"];
        echo "</div>";

        // Fetch and display images based on the r_number
